...
class TagTest < Rugged::TestCase
  ...
  def test_reading_a_tag
    ...
    assert_equal 1_281_578_357, c[:time].to_i
...
class AnnotatedTagTest < Rugged::TestCase
  def setup
    @repo = FixtureRepo.from_libgit2('testrepo.git')
    @tag = @repo.tags.create('annotated_tag', '5b5b025afb0b4c913b4c338a42934a3863bf3644', message: "test tag message\n",
...
class AnnotatedTagObjectTest < Rugged::TestCase
  def setup
    @repo = FixtureRepo.from_libgit2('testrepo.git')
    @annotation = @repo.tags.create_annotation('my-tag', '5b5b025afb0b4c913b4c338a42934a3863bf3644', message: "test tag message\n",
                                                                                                     tagger: { name: 'Scott', email: 'schacon@gmail.com', time: Time.now })
  end
...
class TagWriteTest < Rugged::TestCase
  ...
  def test_writing_a_tag
    tag = @repo.tags.create('tag', '5b5b025afb0b4c913b4c338a42934a3863bf3644', message: "test tag message\n",
                                                                               tagger: { name: 'Scott', email: 'schacon@gmail.com', time: Time.now })
  ...
  def test_tag_invalid_message_type
    assert_raises TypeError do
      @repo.tags.create('tag', '5b5b025afb0b4c913b4c338a42934a3863bf3644', message: :invalid_message,
                                                                           tagger: { name: 'Scott', email: 'schacon@gmail.com', time: Time.now })
    end
  end
