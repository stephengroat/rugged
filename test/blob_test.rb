...
class BlobTest < Rugged::TestCase
  ...
  def test_blob_content_with_size_gt_file_size
    oid = '7771329dfa3002caf8c61a0ceb62a31d09023f37'
    blob = @repo.lookup(oid)
    content = blob.content(1_000_000)
...
class BlobMergeTest < Rugged::TestCase
  ...
  def test_blob_merge_files
    ancestor = { content: @ancestor_content, path: 'file.txt',    filemode: 0o100644 }
    ours =     { content: @our_content,      path: 'newfile.txt', filemode: 0o100644 }
    theirs =   { content: @their_content,    path: 'file.txt',    filemode: 0o100755 }
    ...
    assert_equal 0o100755, result[:filemode]
  ...
  def test_blob_merge_files_by_oid
    ...
    ancestor = { oid: ancestor_oid, path: 'file.txt',    filemode: 0o100644 }
    ours =     { oid: our_oid,      path: 'newfile.txt', filemode: 0o100644 }
    theirs =   { oid: their_oid,    path: 'file.txt',    filemode: 0o100755 }
