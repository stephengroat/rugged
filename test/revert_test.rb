...
class RevertTest < Rugged::TestCase
  ...
  def test_revert_automerge
    expected = [
      [0o100644, 'caf99de3a49827117bb66721010eac461b06a80c', 0, 'file1.txt'],
      [0o100644, '0ab09ea6d4c3634bdf6c221626d8b6f7dd890767', 0, 'file2.txt'],
      [0o100644, 'f4e107c230d08a60fb419d19869f1f282b272d9c', 0, 'file3.txt'],
      [0o100644, '0f5bfcf58c558d865da6be0281d7795993646cee', 0, 'file6.txt']
    ]
  ...
  def test_revert_with_conflicts
    expected = [
      [0o100644, '7731926a337c4eaba1e2187d90ebfa0a93659382', 1, 'file1.txt'],
      [0o100644, '4b8fcff56437e60f58e9a6bc630dd242ebf6ea2c', 2, 'file1.txt'],
      [0o100644, '3a3ef367eaf3fe79effbfb0a56b269c04c2b59fe', 3, 'file1.txt'],
      [0o100644, '0ab09ea6d4c3634bdf6c221626d8b6f7dd890767', 0, 'file2.txt'],
      [0o100644, 'f4e107c230d08a60fb419d19869f1f282b272d9c', 0, 'file3.txt'],
      [0o100644, '0f5bfcf58c558d865da6be0281d7795993646cee', 0, 'file6.txt']
    ]
  ...
  def test_revert_orphan
    expected = [
      [0o100644, '296a6d3be1dff05c5d1f631d2459389fa7b619eb', 0, 'file-mainline.txt']
    ]
