...
class TestRebase < Rugged::TestCase
  ...
  def test_inmemory_resolve_conflicts
    ...
    idx.add(path: 'asparagus.txt', oid: '414dfc71ead79c07acd4ea47fecf91f289afc4b9', mode: 0o100644)
    assert !idx.conflicts?
  ...
  def test_rebase_does_not_lose_files
    Rugged::Commit.create(@repo,                             author: { email: 'rebaser@rebaser.com', time: Time.now, name: 'Rebaser' },
